...
import cosmin.dev.stopwatch.service.ServiceHelper
import cosmin.dev.stopwatch.service.StopwatchService
import cosmin.dev.stopwatch.service.StopwatchState
...
fun MainScreen(stopwatchService: StopwatchService) {
    ...
    Column(
        ...
        Column(
            ...
            // animated content for the hours part
            AnimatedContent(
                targetState = hours,
            ...
            // animated content for the minutes part
            AnimatedContent(
                targetState = minutes,
                transitionSpec = { addAnimation() }
            ) {
            ...
            // animated content for the seconds part
            AnimatedContent(
                targetState = seconds,
                transitionSpec = { addAnimation() }
            ) {
